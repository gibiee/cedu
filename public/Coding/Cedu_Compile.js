function compile() {
  ...
  $("#출력").append("<span style='color:blue'>컴파일 성공!</span>");
...
function 중괄호_세기() {
  ...
  if( left_medium == 0 ) { $("#출력").html("<span style='color:red'>오류 : 중괄호 '{' 가 없습니다!</span>"); return false; }
  else if( right_medium == 0 ) { $("#출력").html("<span style='color:red'>오류 : 중괄호 '}' 가 없습니다!</span>"); return false; }
  else if( left_medium != right_medium ) { $("#출력").html("<span style='color:red'>오류 : 중괄호의 '{', '}'의 개수가 서로 맞지 않습니다!</span>"); return false; }
  return true;
}
function 소괄호_세기() {
  var left_small = ( source_code.match(/\(/g) || [] ).length;
  var right_small = ( source_code.match(/\)/g) || [] ).length;
  if( left_small == 0 ) { $("#출력").html("<span style='color:red'>오류 : 소괄호 '(' 가 없습니다!</span>"); return false; }
  else if( right_small == 0 ) { $("#출력").html("<span style='color:red'>오류 : 소괄호 ')' 가 없습니다!</span>"); return false; }
  else if( left_small != right_small ) { $("#출력").html("<span style='color:red'>오류 : 소괄호의 '(', ')'의 개수가 서로 맞지 않습니다!</span>"); return false; }
  return true;
}
...
function 대괄호_세기() {
  ...
  if( left_big != right_big ) { $("#출력").html("<span style='color:red'>오류 : 대괄호의 '[', ']'의 개수가 서로 맞지 않습니다!</span>"); return false; }
  return true;
}
